...
<template>
  <q-page padding class="row q-col-gutter-sm justify-center">
    ...
    <!-- Planes -->
    <div class="col-12 col-md-6">
      <q-table grid :card-container-class="cardContainerClass" title="Mis Planes" :rows="rows" :columns="columns"
...
deserts.forEach((name) => {
  for (let i = 0; i < 24; i += 1) {
    rows.push({ name: `${name}`, precio: 2000 + Math.ceil(50 * Math.random()) });
  }
});
